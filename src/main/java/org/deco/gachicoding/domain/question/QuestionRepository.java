...
public interface QuestionRepository extends JpaRepository<Question, Long> {
    ...
    Page<Question> findByQContentContainingIgnoreCaseAndQActivatedTrueOrQTitleContainingIgnoreCaseAndQActivatedTrueOrderByQIdxDesc(String qTitle, String qContent, Pageable pageable);
}
